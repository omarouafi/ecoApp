    ...
    return(
        <div className="sign-in">
            ...
            <form onSubmit={handleSubmit}>
                <FormInput  name="email" label="Email" onChange={handleChange} value={email} type="email" required   />
                <FormInput  name="password" label="Password" onChange={handleChange} value={password} type="password" required   />
                <div className="buttons">

                <Btn type="submit">SIGNIN</Btn>
                <Btn google type="button" onClick={googleStart}>SIGNIN WITH GOOGLE</Btn>
                </div>
            </form>
        </div>
    )
